            ...
            <div className='bg-white flex w-[400px] h-[550px] rounded-3xl mt-4 overflow-hidden overflow-y-scroll scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent'>
                ...
                <div  className='p-5 mx-auto flex flex-col gap-3'>
                    ...
                    <div className='mt-3'>
                        ...
                        <input type='text' className='rounded-md border-2 h-9 w-[340px] p-2 outline-none' placeholder='Enter your first name'/>
                    </div>
                    <div className='mt-3'>
                        <h2 className='text-base font-semibold mb-0.5 ml-2'>Last Name</h2>
                        <input type='text' className='rounded-md border-2 h-9 w-[340px] p-2 outline-none' placeholder='Enter your last name'/>
                    </div>
                    <div className='mt-3'>
                        <h2 className='text-base font-semibold mb-0.5 ml-2'>NIC Number</h2>
                        <input type='text' className='rounded-md border-2 h-9 w-[340px] p-2 outline-none' placeholder='Enter your NIC number'/>
                    </div>
                    <div className='mt-3'>
                        <h2 className='text-base font-semibold mb-0.5 ml-2'>Mobile Number</h2>
                        <input type='text' className='rounded-md border-2 h-9 w-[340px] p-2 outline-none' placeholder='Enter your mobile number'/>
                    </div>
                    <div className='mt-3'>
                        <h2 className='text-base font-semibold mb-0.5 ml-2'>Email(Optional)</h2>
                        <input type='text' className='rounded-md border-2 h-9 w-[340px] p-2 outline-none' placeholder='Enter your email'/>
                    </div>
                    <div className='mt-3'>
                        ...
                        <div className='flex gap-5'>
                            <input type='date' className='rounded-md border-2 h-9 w-[175px] p-2 outline-none'/>
                            <select id='gender' className='rounded-md border-2 h-9 w-[140px] p-2 outline-none'>
                                <option>Male</option>
                    ...
                    <div className='mt-3'>
                        ...
                        <div>
                            <input type='password' className='w-full rounded-md border-2 h-9 p-2 outline-none' placeholder='Enter your password'/>
                        </div>
                    </div>
                    <div className='mt-3'>
                        <h2 className='text-base font-semibold mb-0.5 ml-2'>Re-enter Password</h2>
                        <div>
                            <input type='password' className='w-full rounded-md border-2 h-9 p-2 outline-none' placeholder='Re-enter your password'/>
                        </div>
                    </div>
