...
function Dashboard() {
  ...
  return (
    <div className="w-full h-screen bg-slate-100 text-gray-950 dark:bg-gray-950 dark:text-slate-200">
      <div className="fixed right-8 top-8 duration-100 bg-gray-100 dark:bg-slate-800 rounded-lg">
          {/* Themes Button */}
          {options?.map(opt=>(
            <button 
              key={opt.text}
